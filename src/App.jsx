  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <nav style={{
        ...
        position: 'sticky', top: 0, zIndex: 100, transition: 'background 0.25s ease',
      }}>
        <span style={{
          fontWeight: 800, fontSize: 18, marginRight: 16, padding: '16px 0',
        ...
        {TABS.map(t => (
          <button key={t.key} onClick={() => setTab(t.key)} style={{
            padding: '18px 13px 16px', background: 'none', border: 'none',
